...
public class MultipleServentStarter {
    ...
    private static void startServentTest(String testName) {
        ...
        ///dodali smo jos jedan proces za bootstrap
        Process bsProcess = null;
        ProcessBuilder bsBuilder = new ProcessBuilder("java", "-cp", "out\\production\\projekat-vujasin7", "app.BootstrapServer", String.valueOf(AppConfig.BOOTSTRAP_PORT));
        try {
        ...
        for(int i = 0; i < serventCount; i++) {
            try {
                ProcessBuilder builder = new ProcessBuilder("java", "-cp", "out\\production\\projekat-vujasin7", "app.ServentMain",
